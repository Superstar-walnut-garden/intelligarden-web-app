  ...
  return (
    <div
      ...
      <div className="d-flex flex-column align-items-center w-100 mb-3">
        ...
        <div className="d-flex align-items-center w-100 mb-1">
          <label className="text-muted w-auto mx-2"> {localItem.mode === 1 ? "Listen to:" : "Broadcast to:"} </label>
          <select
            title="eventID"
            className={`w-auto mx-1 ${isEditing ? "form-control" : "form-control-plaintext text-muted"}`}
      ...
      <div className="d-flex w-100">
        ...
        <button
          ...
          }`} onClick={() => { if (localItem.event_id === -1) { localItem.status = !localItem.status; onSave(localItem); }}}
        >
